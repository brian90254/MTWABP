...
def colorize_qr_dual(
    ...
    even_dark: Tuple[int, int, int] = (128, 0, 0),    # BLUE (BGR)
    #even_light: Tuple[int, int, int] = (255, 255, 0),  # CYAN (BGR)
    even_light: Tuple[int, int, int] = (0, 255, 255),  # YELLOW (BGR)
    # Odd ring colors (dark/light)
    odd_dark: Tuple[int, int, int] = (0, 0, 128),     # RED (BGR)
    #odd_light: Tuple[int, int, int] = (0, 255, 255),   # YELLOW (BGR)
    odd_light: Tuple[int, int, int] = (255, 255, 0),   # CYAN (BGR)
...
def main():
    ...
    ap.add_argument("--even-dark", default="160,0,0", help="Even ring DARK color (B,G,R). Default BLUE.")
    ap.add_argument("--even-light", default="255,64,64", help="Even ring LIGHT color (B,G,R). Default CYAN.")
    ap.add_argument("--odd-dark", default="0,0,160", help="Odd ring DARK color (B,G,R). Default RED.")
    ap.add_argument("--odd-light", default="64,64,255", help="Odd ring LIGHT color (B,G,R). Default YELLOW.")
