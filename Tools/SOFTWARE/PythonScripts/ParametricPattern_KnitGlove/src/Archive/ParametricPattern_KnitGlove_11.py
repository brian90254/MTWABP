...
# top_y = start_y  # top of WRIST RIB
# bottom_y = finger_end_y  # bottom of FINGER RIB
...
# Extract subregion and mirror it horizontally
region = image[top_y:bottom_y + 1, left_inner_x:right_inner_x + 1]
# mirrored = np.flip(region, axis=1)
...
if mirrored.size == 0:
    ...
    # cv2.imwrite(mirror_filename, mirrored)
