...
# SHORT PALM
#palmHeightRatio = 2.261 # 42 courses total
# LONG PALM
palmHeightRatio = 3.50 # 56 courses total
#palmHeightRatio = 3.310 # 54 courses total
#palmHeightRatio = 3.2 # 52 courses total
# ----------------------------
# WRIST
...
# LONG PALM
#fingerRibHeight = round_to_nearest_odd(palmHeight / 4)
#fingerRibHeight = round_to_nearest_odd(palmHeight / 5)
fingerRibHeight = round_to_nearest_odd(palmHeight / fingerHeightRatio)
#thumbDrop = round_to_nearest_even(0.4 * palmWidth)
#thumbDrop = round_to_nearest_even(0.45 * palmWidth)
