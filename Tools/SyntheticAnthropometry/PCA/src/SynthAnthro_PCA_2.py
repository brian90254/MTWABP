...
filename = "CSV/SynthAnthro_SizeAndShape_CSV_FEMALE_8.csv"  # <- Change to your actual filename
#filename = "CSV/SynthAnthro_ShapeOnly_CSV_MALE_12.csv"  # <- Change to your actual filename
