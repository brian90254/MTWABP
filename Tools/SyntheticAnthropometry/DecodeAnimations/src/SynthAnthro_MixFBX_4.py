...
def average_ascii_fbx_with_bones(text1, text2):
    # Extract vertex and normal arrays and their formatting prefix
    ...
    # Replace in original text with restored formatting
    text1 = replace_block(text1, v1_span, avg_vertices, add_prefix=v_prefix)
    text1 = replace_block(text1, n1_span, avg_normals, add_prefix=n_prefix)

    # Handle bone transform averaging
